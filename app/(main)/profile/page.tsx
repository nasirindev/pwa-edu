      ...
      <div className="fixed inset-0 flex items-center justify-center overflow-hidden">
        ...
        <div className="w-full max-w-250 aspect-video max-h-screen relative shadow-2xl overflow-hidden bg-white border-4 border-gray-800 rounded-3xl">
          <div className="h-full w-full flex flex-col p-4 md:p-6 relative space-y-4">
            ...
            <div className="flex-1 flex gap-6 items-stretch overflow-hidden pt-2">
              {/* Sisi Kiri: foto pembuat */}
              <motion.div
                initial={{ opacity: 0, x: -20 }}
                animate={{ opacity: 1, x: 0 }}
                className="w-1/3 min-w-[90px] sm:min-w-[120px] md:min-w-[150px] h-full"
              >
                <div className="w-full h-full bg-orange-400 border-4 border-gray-800 rounded-2xl flex items-center justify-center shadow-[6px_6px_0px_#1f2937] overflow-hidden relative">
                  ...
                  <User size={60} className="text-white absolute animate-pulse" />
                </div>
              </motion.div>
